<?php
    ...
    $sql = "SELECT *  FROM `carlist` WHERE `username` = '$username' AND `goods_id` = '$goods_id'";
    ...
    if(!$row){
        ...
        // 把这条数据添加到购物车表
        $addSql = "INSERT INTO `carlist` VALUES (null, '$username', '$goods_id', '1')";
        ...
        $updat = "UPDATE `carlist` SET `goods_num` = '$goods_num' WHERE `username` = '$username' AND `goods_id` = '$goods_id'";
